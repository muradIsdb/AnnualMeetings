...
namespace IsDB.Hospitality.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddTravelTracking : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<string>(
                name: "AirlineName", table: "Flights", type: "TEXT", maxLength: 100, nullable: false, defaultValue: "");

            migrationBuilder.AddColumn<string>(
                name: "ArrivalPortIataCode", table: "Flights", type: "TEXT", nullable: true);

            migrationBuilder.AddColumn<string>(
                name: "ArrivalPortName", table: "Flights", type: "TEXT", maxLength: 100, nullable: true);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                name: "ScheduledDeparture", table: "Flights", type: "TEXT", nullable: true,
                oldClrType: typeof(DateTime), oldType: "TEXT");

            migrationBuilder.AlterColumn<DateTime>(
                name: "ScheduledArrival", table: "Flights", type: "TEXT", nullable: true,
                oldClrType: typeof(DateTime), oldType: "TEXT");

            migrationBuilder.AddColumn<string>(
                name: "ArrivalAirportCode", table: "Flights", type: "TEXT", maxLength: 10, nullable: true);
            migrationBuilder.AddColumn<string>(
                name: "DelayReason", table: "Flights", type: "TEXT", maxLength: 500, nullable: true);
            migrationBuilder.AddColumn<string>(
                name: "DepartureAirportCode", table: "Flights", type: "TEXT", maxLength: 10, nullable: true);
            migrationBuilder.AddColumn<Guid>(
                name: "GuestId", table: "Flights", type: "TEXT", nullable: false,
                defaultValue: new Guid("00000000-0000-0000-0000-000000000000"));
            migrationBuilder.AddColumn<bool>(
                name: "IsArrival", table: "Flights", type: "INTEGER", nullable: false, defaultValue: false);
