...
public interface IEventsAirClient
{
    ...
    /// <summary>
    /// Fetches all travel bookings for the event from the EventsAir GraphQL API.
    /// </summary>
    Task<List<EventsAirTravelDto>> GetTravelBookingsAsync(CancellationToken cancellationToken = default);
}
